    ...
    public class Фотокиоск : ICSSoft.STORMNET.DataObject
    {
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ФотокиоскE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ФотокиоскE", typeof(IIS.Kursovaya7.Фотокиоск));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ФотокиоскL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ФотокиоскL", typeof(IIS.Kursovaya7.Фотокиоск));
                }
            }
        }
    }
