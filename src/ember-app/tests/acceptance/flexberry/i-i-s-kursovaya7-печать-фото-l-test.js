...
moduleForAcceptance('[AGAT] Acceptance | i i s kursovaya7 печать фото l');

test('testing i-i-s-kursovaya7-печать-фото-l', function(assert) {
  visit('/i-i-s-kursovaya7-печать-фото-l');
