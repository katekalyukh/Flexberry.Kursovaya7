...
moduleForAcceptance('[AGAT] Acceptance | i i s kursovaya7 фотокиоск l');

test('testing i-i-s-kursovaya7-фотокиоск-l', function(assert) {
  visit('/i-i-s-kursovaya7-фотокиоск-l');
